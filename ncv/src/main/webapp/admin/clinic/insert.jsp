...
<form action="<%=request.getContextPath()%>/clinic/clinicInsert.txt" method="post" name="form">
	<div class="container-400 container-center">
	<div class="row">
	<input type="text" name="clinicName" placeholder="병원 이름"class="form-input">
	</div>
	<div class="row">
	<input type="text" name="clinicTel" placeholder="병원 전화번호"class="form-input">
	</div>
	<div class="row">
	<textarea name="clinicTime" placeholder="병원 운영시간" rows="10" cols="62" class="text-input"></textarea>
	</div>
	<div class="row">
    <input type="text" name="clinicPostcode" placeholder="우편번호"class="form-input">
    <button type="button" class="find-address-btn form-inline">주소 찾기</button><br>
    <input type="text" name="clinicAddress" placeholder="주소"class="form-input">
    </div>
	<div class="row">
	<input type="text" name="clinicDetailAddress" placeholder="상세주소"class="form-input">
	</div>
