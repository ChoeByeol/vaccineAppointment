...
<body>
	...
	<form action="<%=request.getContextPath()%>/admin/member/agreeEdit.txt" method="post" name="form">
	    ...
	    <textarea name="agree1" class="text-input"></textarea>
	    </div>
	    <div class="row">
	    <label class="label-text">약관2</label>
	    <textarea name="agree2" class="text-input"></textarea>
	    </div>
	    <div class="row">
	    <label class="label-text">약관3</label>
	    <textarea name="agree3" class="text-input"></textarea>
	    </div>
	    <div class="row">
	    <label class="label-text">약관4</label>
	    <textarea name="agree4" class="text-input"></textarea>
	    </div>
		<div class="row">
