...
public class ShotVo {
	...
	public String getClinicDetailAddress() {
		return clinicDetailAddress;
	}
	...
	public String getVaccinLife() {
		return vaccinLife;
	}
	public void setVaccinLife(String vaccinLife) {
		this.vaccinLife = vaccinLife;
	}
